...
export default async function CoursePage({ params }: { params: Promise<{ crn: string }> }) {
  ...
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 24px', fontFamily: 'Inter, sans-serif' }}>
      ...
      <p style={{ color: '#6B7280', fontSize: '16px', marginBottom: '8px' }}>{course.title}</p>
      ...
      <div style={{
        ...
        <span style={{ fontSize: '13px', color: '#6B7280', fontWeight: 600 }}>Enrollment Code:</span>
        <code style={{ fontSize: '14px', fontWeight: 700, color: '#166534', letterSpacing: '0.05em' }}>
          {course.secret}
        </code>
      </div>
    </div>
